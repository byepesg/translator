...
public interface LPP_grammarListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link LPP_grammarParser#id}.
	 * @param ctx the parse tree
	 */
	void enterId(LPP_grammarParser.IdContext ctx);
	/**
	 * Exit a parse tree produced by {@link LPP_grammarParser#id}.
	 * @param ctx the parse tree
	 */
	void exitId(LPP_grammarParser.IdContext ctx);
	/**
	 * Enter a parse tree produced by {@link LPP_grammarParser#integer}.
	 * @param ctx the parse tree
	 */
	void enterInteger(LPP_grammarParser.IntegerContext ctx);
	/**
	 * Exit a parse tree produced by {@link LPP_grammarParser#integer}.
	 * @param ctx the parse tree
	 */
	void exitInteger(LPP_grammarParser.IntegerContext ctx);
	/**
	 * Enter a parse tree produced by
	 * @param ctx the parse tree
	 */
	void enterDouble(LPP_grammarParser.DoubleContext ctx);
	/**
	 * Exit a parse tree produced by
	 * @param ctx the parse tree
	 */
	void exitDouble(LPP_grammarParser.DoubleContext ctx);
	/**
	 * Enter a parse tree produced by
	 * @param ctx the parse tree
	 */
	void enterChar(LPP_grammarParser.CharContext ctx);
	/**
	 * Exit a parse tree produced by
	 * @param ctx the parse tree
	 */
	void exitChar(LPP_grammarParser.CharContext ctx);
	/**
	 * Enter a parse tree produced by {@link LPP_grammarParser#string}.
	 * @param ctx the parse tree
	 */
	void enterString(LPP_grammarParser.StringContext ctx);
	/**
	 * Exit a parse tree produced by {@link LPP_grammarParser#string}.
	 * @param ctx the parse tree
	 */
	void exitString(LPP_grammarParser.StringContext ctx);
	/**
	 * Enter a parse tree produced by
	 * @param ctx the parse tree
	 */
	void enterBoolean(LPP_grammarParser.BooleanContext ctx);
	/**
	 * Exit a parse tree produced by
	 * @param ctx the parse tree
	 */
	void exitBoolean(LPP_grammarParser.BooleanContext ctx);
}